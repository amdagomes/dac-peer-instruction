 ...
 * @author Amanda
 */
//Define a classe Filme como entidade
@Entity
public class Filme implements Serializable {

    //define o atributo id como primary key e seu valor é gerado automaticamente
    @Id
    @GeneratedValue
    private int id;
    private String titulo;
    //define que o atributo representa um texto longo e que deve ser carregado sob demanda 
    @Lob
    @Basic(fetch = FetchType.LAZY)
    private String sinopse;
    private String genero;
    //define que o atributo trbalha com o tempo e que deve recuperar apenas a data
